...
void output_sensors_text(char raw_or_calibrated)
{
  ...
  Serial.print(accel[0]); Serial.print("_");
  Serial.print(accel[1]); Serial.print("_");
  Serial.print(accel[2]); Serial.print("_");
  ...
  Serial.print(gyro[0]); Serial.print("_");
  Serial.print(gyro[1]); Serial.print("_");
  Serial.print(gyro[2]); Serial.print("_");
